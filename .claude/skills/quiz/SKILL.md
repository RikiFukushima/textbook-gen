...
クイズは到達確認や試験ではなく、**学習者が自分の実力を軽く測るためのアウトプット**(=「軽い自己測定」)。**試験化しない**。難問・引っかけ・本文に根拠のない応用で詰まらせない。learning_points の網羅も求めない(全項目を埋めるノルマではなく、偏らず広く触れていれば十分)。詳細な出題規約は `textbook-style` §5 参照。
