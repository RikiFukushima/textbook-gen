...
まず知ってほしいのは、これは **あなたの書き方が下手だからではない** ということです。今のAIは動画を「1コマずつそれらしく描いてつなぐ」しくみで作っているため、コマ同士のつじつまが合わなくなると崩れます。プロのクリエイターでも何度も出し直します。崩れたら直す、を前提にすれば気が楽になります。
...
1. **一貫性の崩れ** ― 途中で顔・服・色が変わる。AIがコマごとに別々に描いてしまうために起きます。
