...
learning_points:
  ...
  - シャドウ運用と A-B テストによる段階リリースの違いと目的を説明できる
...
- シャドウ運用と A-B テスト、2 つの段階リリースの違いと目的
...
評価データセットで手元の精度を測れても、本番の生きたトラフィックで通用するかは別問題です。そこでいきなり全開放せず、**段階的にリリース** します。代表的な 2 つが「シャドウ運用」と「A-B テスト」です。
...
- シャドウ運用で安全に精度を測り、A-B テストで実効果を確かめてから広げる
