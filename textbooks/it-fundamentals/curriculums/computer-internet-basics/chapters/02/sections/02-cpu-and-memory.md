...
CPU が仕事をするには、いま使っている情報をすぐ手の届く場所に広げておく必要があります。その置き場所が**メモリ**です。メモリは「作業机」にたとえるとわかりやすい部品です。なお、メモリは正式には**メインメモリ**と呼ばれ、英語の頭文字から **RAM** と呼ばれることもあります。本書では親しみやすい「メモリ」で通します。
