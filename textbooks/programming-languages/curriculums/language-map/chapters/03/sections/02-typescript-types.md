...
実務では、一人で素早く試すだけの小さなコードなら素の JavaScript で十分なこともあります。一方、複数人で長く育てていく Web アプリでは、最初から TypeScript を選んでおくと、型が「コードの取扱説明書」のように働き、読み手の負担を減らしてくれます。前のセクションで見た JavaScript の手軽さに、Java のような型の堅さを少しだけ持ち込んだもの――そんな位置づけで覚えておくと、この章の最後のセクション(03-04)で 3 言語を並べるときに整理しやすくなります。
