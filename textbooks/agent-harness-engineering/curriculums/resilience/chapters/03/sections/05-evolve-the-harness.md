...
エージェントの harness は、一度組んだら完成、というものではありません。モデルは更新され、ユーザーの使い方は変わり、新しい壊れ方が現れます。だから harness は、運用しながら**少しずつ直し続ける**前提でつくります。観測で見つけた失敗を評価ケースに足し(03-03)、外れ値を予算で抑え(01 章)、回復の手筋を増やす(02 章)——この積み重ねが、harness を強くしていきます。
